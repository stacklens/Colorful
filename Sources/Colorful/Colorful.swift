...
public extension Color {
  ...
  // MARK: - Shades Of Grass
  private var _ShadesOfGrass: [UIColor] {[#colorLiteral(red: 0.5490196078, green: 0.7098039216, blue: 0.3921568627, alpha: 1), #colorLiteral(red: 0.6705882353, green: 0.8, blue: 0.4235294118, alpha: 1), #colorLiteral(red: 0.368627451, green: 0.4588235294, blue: 0.3098039216, alpha: 1), #colorLiteral(red: 0.4901960784, green: 0.5764705882, blue: 0.3215686275, alpha: 1), #colorLiteral(red: 0.6862745098, green: 0.7058823529, blue: 0.4392156863, alpha: 1), #colorLiteral(red: 0.7647058824, green: 0.8117647059, blue: 0.5411764706, alpha: 1)]}
  static var dollarBill: Color { Color(hex: "8CB564") }
  static var middleGreenYellow: Color { Color(hex: "ABCC6C") }
  static var axolotl: Color { Color(hex: "5E754F") }
  static var mossGreen: Color { Color(hex: "7D9352") }
  static var mistyMoss: Color { Color(hex: "AFB470") }
  static var mediumSpringBud: Color { Color(hex: "C3CF8A") }
  
  // MARK: - Shades Of The Sun
  private var _ShadesOfTheSun: [UIColor] {[#colorLiteral(red: 1, green: 0.3882352941, blue: 0.3215686275, alpha: 1), #colorLiteral(red: 1, green: 0.4941176471, blue: 0.1803921569, alpha: 1), #colorLiteral(red: 1, green: 0.6156862745, blue: 0.1215686275, alpha: 1), #colorLiteral(red: 1, green: 0.737254902, blue: 0.06666666667, alpha: 1), #colorLiteral(red: 1, green: 0.8588235294, blue: 0.007843137255, alpha: 1), #colorLiteral(red: 1, green: 0.9647058824, blue: 0.4509803922, alpha: 1)]}
  static var sunsetOrange: Color { Color(hex: "FF6352") }
  static var crayolasOrange: Color { Color(hex: "FF7E2E") }
  static var crayolasBrightYellow: Color { Color(hex: "FF9D1F") }
  static var mikadoYellow: Color { Color(hex: "FFBC11") }
  static var sizzlingSunrise: Color { Color(hex: "FFDB02") }
  static var sunny: Color { Color(hex: "FFF673") }
  ...
  // MARK: - Strong Autumn
  private var _StrongAutumn: [UIColor] {[#colorLiteral(red: 0.8823529412, green: 0.7607843137, blue: 0.431372549, alpha: 1), #colorLiteral(red: 0.2784313725, green: 0.4392156863, blue: 0.3568627451, alpha: 1), #colorLiteral(red: 0.05882352941, green: 0.1490196078, blue: 0.2117647059, alpha: 1), #colorLiteral(red: 0.5647058824, green: 0.168627451, blue: 0.168627451, alpha: 1), #colorLiteral(red: 0.7333333333, green: 0.3764705882, blue: 0.3215686275, alpha: 1), #colorLiteral(red: 0.9019607843, green: 0.768627451, blue: 0.5882352941, alpha: 1)]}
  static var sAarylideYellow: Color { Color(hex: "E1C26E") }
  static var amazon: Color { Color(hex: "47705B") }
  static var sAyankeesBlue: Color { Color(hex: "0F2636") }
  static var vividAuburn: Color { Color(hex: "902B2B") }
  static var electricBrown: Color { Color(hex: "BB6052") }
  static var crayolasGold: Color { Color(hex: "E6C496") }
